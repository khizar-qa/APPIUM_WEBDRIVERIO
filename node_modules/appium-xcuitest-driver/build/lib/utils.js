...
async function getAndCheckXcodeVersion() {
    ...
    let version;
    try {
        version = /** @type {XcodeVersion} */ (await appium_xcode_1.default.getVersion(true));
    }
    catch (err) {
...
async function getAndCheckIosSdkVersion() {
    try {
        return await appium_xcode_1.default.getMaxIOSSDK();
    }
    catch (err) {
...
function normalizePlatformVersion(originalVersion) {
    const normalizedVersion = semver_1.default.coerce(originalVersion);
